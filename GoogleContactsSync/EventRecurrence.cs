    ...
    class EventRecurrence
    {
        ...
        public EventRecurrence(Recurrence googleRecurrence, List<EventEntry> recurrenceExceptions = null)
        {
            ...
            else if (this.Frequency == RecurrenceFrequency.Monthly)
            {
                ...
                this.DayOfMonth = byMonthDayMatch.Success ? Convert.ToInt32(byMonthDayMatch.Groups[1].Value) : 0;
            ...
            else if (this.Frequency == RecurrenceFrequency.Yearly)
            {
                ...
                if ((this.Interval != 1) && (Properties.Settings.Default.OutlookVersion < 14))
                    throw new IncompatibleRecurrencePatternException(Target.Google, Properties.Resources.Error_WrongYearlyInterval);
            }
