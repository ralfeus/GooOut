    ...
    internal class OutlookUtilities
    {
        ...
        internal static string GetGoogleID(object item)
        {
            ...
            try
            {
                ...
                property = properties[Properties.Settings.Default.ExtendedPropertyName_GoogleIDInOutlookItem];
                if (property != null)
        ...
        internal static void SetGoogleID(object item, string googleItemID)
        {
            ...
            try
            {
                ...
                for (var i = 0; i < properties.Count; i++)
                {
                    ...
                    if (property.Name == Properties.Settings.Default.ExtendedPropertyName_GoogleIDInOutlookItem)
                    {
                ...
                if (googleIDProperty == null)
                    googleIDProperty = properties.Add(Properties.Settings.Default.ExtendedPropertyName_GoogleIDInOutlookItem, OlUserPropertyType.olText);
        ...
        internal static void RemoveGoogleID(object outlookItem)
        {
            ...
            {
                if (properties[i].Name == Properties.Settings.Default.ExtendedPropertyName_GoogleIDInOutlookItem)
                {
                    properties.Remove(i);
                    --i;
                }
        ...
        {
            var reconnections = Properties.Settings.Default.AttemptsAmount;
        ...
        internal static string GetDefaultOutlookProfile()
        {
            try
            {
                var profilesKey = Registry.CurrentUser.OpenSubKey(Properties.Settings.Default.Registry_Key_OutlookProfiles);
                return profilesKey.GetValue(Properties.Settings.Default.Registry_Value_OutlookDefaultProfile).ToString();
            }
            catch (System.Exception)
            {
                return "";
        ...
        internal static string[] GetOutlookProfiles()
        {
            try
            {
                var profilesKey = Registry.CurrentUser.OpenSubKey(Properties.Settings.Default.Registry_Key_OutlookProfiles);
                return profilesKey.GetSubKeyNames();
            }
            catch (System.Exception)
            {
                return null;
